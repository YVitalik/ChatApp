...
{
    public class IntermediateUserService : IIntermediateUserService
    {
        private readonly HttpClient _httpClient;
        private readonly ILocalStorageService _localStorage;
        private string _baseUrl;

        public IntermediateUserService(HttpClient httpClient, ILocalStorageService localStorage, IConfiguration configuration)
        {
        ...
        private async Task SaveToken(HttpResponseMessage response)
        {
            ...
            var tokenHelper = JsonConvert.DeserializeObject<JwtToken>(responseContent);
